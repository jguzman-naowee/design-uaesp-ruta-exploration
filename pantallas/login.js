...
window.PANTALLAS.login = {
  ...
  render: function (ctx) {
    ...
    var perfiles = D.roles.map(function (r) {
      return S.card({
    ...
    return S.h('div', { class: 'nws-login' },
      S.h('a', { class: 'nws-sticker nws-sticker--salmon nws-login__showroom', href: '#/showroom', 'data-ir': '#/showroom', 'aria-label': 'Ver el showroom del demo' },
        S.icon('thunder'), S.h('span', null, 'Showroom')),
      S.h('div', { class: 'nws-login__head' },
